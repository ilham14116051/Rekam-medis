...
// test PDF
Route::get('/rekam_medis/pdf/{id}', [RekamMedisController::class, 'PDF'])->middleware(['dokter'])->name('rmpdf');
Route::get('/transaction_detail/pdf/{id}', [TransactionDetailController::class, 'PDF'])->middleware(['dokter'])->name('invpdf');
...
Route::resource('events', EventController::class)->middleware(['dokter']);
