        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="kd_product" class="col-lg-2 col-lg-offset-1 control-label">Kode</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="nm_product" class="col-lg-2 col-lg-offset-1 control-label">Nama</label>
                        <div class="col-lg-6">
