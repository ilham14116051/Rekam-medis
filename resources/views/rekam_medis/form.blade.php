        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="suhu_tubuh" class="col-lg-2 col-lg-offset-1 control-label">Suhu Tubuh (C)</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="berat_badan" class="col-lg-2 col-lg-offset-1 control-label">Berat Badan(g)</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="age" class="col-lg-2 col-lg-offset-1 control-label">Umur (bulan)</label>
                        <div class="col-lg-6">
